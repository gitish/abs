...
var ProfileComponent = /** @class */ (function () {
    ...
    ProfileComponent.prototype.showReports = function (data) {
        var _this = this;
        this.showSelected = false;
        this.showUserReports = true;
        this.authService.getReport(data.id).subscribe(function (data) {
            if (data.success) {
